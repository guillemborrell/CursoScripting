...
completarse en un par de horas y asimilarse en unos pocos días. La
consola interactiva es completamente funcional y es de gran ayuda para
probar cosas nuevas. Esta es, por ejemplo, la manera más sencilla de
sacar por pantalla la serie de Fibonacci:
...
modo que el tutorial oficial del
lenguaje\footnote{\url{http://docs.python.org/tut/tut.html}} se convierte a
...
coma flotante es la de doble precisión, es decir, el \emph{double} de C.
\section{Numpy}
