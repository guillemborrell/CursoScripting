...
\begin{itemize}
 \item[Java] Menos problemas de licencias y más productividad.
 \item[Smalltalk] Más extendido.
 \item[Perl] Para seres humanos
 \item[Ruby] Más simple.
 \item[C\#] Libre, multiplataforma.
\end{itemize}
...
\begin{itemize}
 ...
 \item No hay una implementación propia de Arrays y Buffers
...
\begin{frame}[containsverbatim]
 \frametitle{Un wrapper sencillo}
\begin{verbatim}
